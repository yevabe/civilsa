...
@section('content')
<section class="welcome top bg-cover py-md-8">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header mb-0 font-weight-bold" style="text-shadow:0 1px 2px rgba(0, 0, 0, 0.25);">
                        <div class="row  mb-0">
                            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row mb-0 float-md-right float-xs-none">
                                <div class="col-md-12">
